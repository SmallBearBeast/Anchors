...
class Datas {
    ...
    fun startFromApplicationOnMainProcessByDsl_1(): AnchorsManager {
        return AnchorsManager.getInstance()
            .debuggable { true }
     ...
     */
    fun startFromApplicationOnMainProcessByDsl(): AnchorsManager {
        return AnchorsManager.getInstance()
            .debuggable { true }
            .taskFactory { TestTaskFactory() }
    ...
    fun startFromApplicationOnPrivateProcess(): AnchorsManager  {
        return AnchorsManager.getInstance()
            .debuggable { true }
            .taskFactory { TestTaskFactory() }
    ...
    fun startFromApplicationOnPublicProcess(): AnchorsManager  {
        return AnchorsManager.getInstance()
            .debuggable { true }
            .taskFactory { TestTaskFactory() }
...
//        return lockableAnchor
    ...
    fun startAllAsyncTask() {
        val manager = AnchorsManager.getInstance()
            .debuggable { true }
            .taskFactory { TestTaskFactory() }
            .anchors { arrayOf(ASYNC_TASK_3) }
            .graphics {
                arrayOf(
                    ASYNC_TASK_1.sons(
                        ASYNC_TASK_2.sons(
    ...
    fun startAllSyncTask() {
        val manager = AnchorsManager.getInstance()
            .debuggable { true }
            .taskFactory { TestTaskFactory() }
            .anchors { arrayOf(UITHREAD_TASK_C) }
            .graphics {
                arrayOf(
                    UITHREAD_TASK_A.sons(
                        UITHREAD_TASK_B.sons(
                            UITHREAD_TASK_C
                        )
                    )
                )
